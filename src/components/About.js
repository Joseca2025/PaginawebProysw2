...
const About = () => {
  return (
    <AboutContainer>
      ...
      >
        Soluciones Magistrales e innovadoras "J&J Software Creations" es una empresa enmarcada en el ámbito de las ciencias de la computación con énfasis en la tecnología del desarrollo de software y la innovación.
      </Description>
      <Section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div>
          <img src="/images/jose.jpeg" alt="Representante 1" />
          <motion.h3
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div>
          <img src="/images/rapu.jpeg" alt="Representante 2" />
          <motion.h3
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
