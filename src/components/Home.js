...
const testimonials = [
  {
    quote: 'J&J Software Creations ha transformado nuestra forma de trabajar. Sus soluciones son innovadoras y eficaces.',
    author: 'Juan Pérez, CEO de Multicenter'
  },
  {
    quote: 'La colaboración con J&J Software Creations ha sido una experiencia muy positiva. Su equipo es profesional y altamente cualificado.',
    author: 'Maria Gómez, Directora de TI en Tailoy'
  },
  {
    quote: 'Gracias a J&J Software Creations, hemos podido optimizar nuestros procesos internos y mejorar significativamente nuestra eficiencia.',
    ...
    <HomeContainer>
      <WelcomeText>
        <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
          Bienvenido a J&J Software Creations
        </motion.h1>
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5, duration: 1 }}>
          En J&J Software Creations, nos especializamos en desarrollar soluciones tecnológicas a medida que transforman sus ideas en realidad. Desde aplicaciones móviles innovadoras hasta sistemas web robustos, nuestro equipo está dedicado a llevar su proyecto al siguiente nivel.
        </motion.p>
      </WelcomeText>
