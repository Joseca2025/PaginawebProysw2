      ...
      const response = await fetch(
        'https://api.openai.com/v1/chat/completions',
        {
          ...
          body: JSON.stringify({
            model: 'gpt-3.5-turbo',
            messages: [
              { role: 'system', content: 'Eres un asistente útil para la empresa J&J Software Creations. Responde preguntas sobre la empresa, incluyendo información de contacto, misión, visión, y enlaces a redes sociales.' },
